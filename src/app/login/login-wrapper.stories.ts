...
const Template: Story<LoginWrapperComponent> = (
  args: LoginWrapperComponent
) => ({
  component: LoginWrapperComponent,
  props: args,
});
...
Demo.args = {
  ...
  signinGreetingTitle:
    DEFAULT_TRANSLATION_DICTIONARY.SIGNIN_FORM__GREETING_TITLE,
  signinGreetingSubtitle:
    DEFAULT_TRANSLATION_DICTIONARY.SIGNIN_FORM__GREETING_SUBTITLE,
  signupGreetingTitle:
    DEFAULT_TRANSLATION_DICTIONARY.SIGNUP_FORM__GREETING_TITLE,
  signupGreetingSubtitle:
    DEFAULT_TRANSLATION_DICTIONARY.SIGNUP_FORM__GREETING_SUBTITLE,
  forgotPasswordGreetingTitle:
    DEFAULT_TRANSLATION_DICTIONARY.FORGOT_PASSWORD_FORM__GREETING_TITLE,
  forgotPasswordGreetingSubtitle:
    DEFAULT_TRANSLATION_DICTIONARY.FORGOT_PASSWORD_FORM__GREETING_SUBTITLE,
  signinFormLabelUsername:
    DEFAULT_TRANSLATION_DICTIONARY.SIGNIN_FORM__LABEL_USERNAME,
  signinFormLabelPassword:
    DEFAULT_TRANSLATION_DICTIONARY.SIGNIN_FORM__LABEL_PASSWORD,
  signupFormLabelGivenname:
    DEFAULT_TRANSLATION_DICTIONARY.SIGNUP_FORM__LABEL_GIVENNAME,
  signupFormLabelFamilyname:
    DEFAULT_TRANSLATION_DICTIONARY.SIGNUP_FORM__LABEL_FAMILYNAME,
  signupFormLabelEmail: DEFAULT_TRANSLATION_DICTIONARY.SIGNUP_FORM__LABEL_EMAIL,
  signupFormLabelPassword:
    DEFAULT_TRANSLATION_DICTIONARY.SIGNUP_FORM__LABEL_PASSWORD,
  signupFormLabelRetypePassword:
    DEFAULT_TRANSLATION_DICTIONARY.SIGNUP_FORM__LABEL_RETYPEPASSWORD,
  forgotPasswordFormLabelEmail:
    DEFAULT_TRANSLATION_DICTIONARY.FORGOT_PASSWORD_FORM__LABEL_EMAIL,
  resendVerifyLinkFormGreetingTitle:
    DEFAULT_TRANSLATION_DICTIONARY.RESEND_VERIFY_LINK_FORM__GREETING_TITLE,
  resendVerifyLinkFormGreetingSubtitle:
    DEFAULT_TRANSLATION_DICTIONARY.RESEND_VERIFY_LINK_FORM__GREETING_SUBTITLE,
  resendVerifyLinkFormLabelEmail:
    DEFAULT_TRANSLATION_DICTIONARY.RESEND_VERIFY_LINK_FORM__LABEL_EMAIL,
